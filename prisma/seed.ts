...
async function main() {
  ...
  console.log('分类创建成功:', techCategory.name, productCategory.name);
...
cd my-first-model</code></pre>
  ...
  console.log('文章创建成功:');
  console.log('-', post1.title, '(已发布)');
  console.log('-', post2.title, '(已发布)');
  console.log('-', post3.title, '(草稿)');

  console.log('\n测试数据添加完成！');
  console.log('你可以访问:');
  console.log('- 前端博客: http://localhost:3000/zh/blog');
  console.log('- 管理后台: http://localhost:3000/admin/posts');
}
