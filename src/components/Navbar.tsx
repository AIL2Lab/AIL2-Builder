    ...
    <div className="w-full sticky flex items-center justify-center top-6 md:top-12 z-50">
          ...
          {navbarLeft.map((item, idx) => {
            ...
            return (
              <div
                ...
                className={`${
                  idx === 0 ? "ml-5 lg:ml-10" : ""
                } text-base font-normal ${isActive ? "text-theme" : ""}`}
              >
        ...
        <div className="flex col-span-1 items-center pl-20 space-x-4 lg:space-x-6 xl:space-x-12">
          ...
          <div className="text-base font-normal flex flex-1 justify-end ml-4 lg:ml-8">
            ...
            <a
              ...
              className="document-icon ml-2.5"
            >
              <Document />
            </a>
      ...
      <nav className="w-full flex items-center justify-between md:hidden px-2.5">
        ...
        <div className="flex-1 flex justify-end">
          <Link
            href="/"
            className="bg-white/10 justify-center items-center rounded-xl px-2.5  hidden sm:flex"
          >
            <Github />
          </Link>
          <Link
            href="/docs"
            className="bg-white/10 justify-center items-center rounded-xl px-2.5  mx-2.5 hidden sm:flex"
          >
            <Document />
          </Link>
          <LanguageSwitcher />
