...
export default function Footer() {
  ...
  return (
    <footer className="footer w-full mx-auto lg:max-w-7xl md:my-24 lg:my-32 ">
      <div className="grid grid-cols-6 p-5 lg:p-10 xl:p-20 space-y-20 md:space-y-0">
        ...
        <div className="col-span-6 md:col-span-3 grid grid-cols-3 pl-10  lg:pl-20 xl:pl-40">
